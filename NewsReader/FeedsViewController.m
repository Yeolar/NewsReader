...
- (void)viewDidLoad
{
    ...
    self.title = NSLocalizedString(@"Newspaper List", @"The title of the newspaper list view.");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[[NSString alloc] initWithFormat:@"%@", feed.name] autorelease];
    cell.textLabel.font = [UIFont systemFontOfSize:TITLE_FSIZE];
    if ([feed.cached boolValue]) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([fetchedItems count] != 0) {
        ...
        xmlDownloader.xmlURLString = feed.link;
